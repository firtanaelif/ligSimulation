 ...
 */
final class Version20190715160752 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, home_team_id INT NOT NULL, away_team_id INT NOT NULL, home_goal_count INT NOT NULL, away_goal_count INT NOT NULL, is_finish TINYINT(1) NOT NULL, week INT NOT NULL, INDEX IDX_7A5BC5059C4C13F6 (home_team_id), INDEX IDX_7A5BC50545185D02 (away_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
